...
<table width="98%" border="0">
  <form name="form2" action="client.do" method="post" onsubmit="return checkname(this)">
  <tr>
    <td width="4"></td>
...
<form action="delclient.do" method="post" name="form1" target="main" id="form1" onsubmit="return CheckForm()">
<table width="98%" border="0">
  <tr>
    <td width="4">&nbsp;</td>
    <td height="25" align="left"  style="border-bottom: dashed 1px"><img src="../images/dot_process.gif" width="7" height="7" />&nbsp;管理员管理 &gt;&gt;&nbsp;注册用户信息列表</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="25" align="left" valign="top"  style="line-height:150%">
      <table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#B1C3D9" id=table1 style="margin-top:5px;">
        <tr class="line_bottom">
          ...
          <th height="31" align="center" valign="middle" bgcolor="#FFFFFF" class="line_bottom">帐号</th>
          ...
          <th height="31" align="center" valign="middle" bgcolor="#FFFFFF" class="line_bottom">出生日期</th>
          <th height="31" align="center" valign="middle" bgcolor="#FFFFFF" class="line_bottom">身份证号</th>
          <th height="31" align="center" valign="middle" bgcolor="#FFFFFF" class="line_bottom">电话</th>
          <th height="31" align="center" valign="middle" bgcolor="#FFFFFF" class="line_bottom">地址</th>
          <th height="31" align="center" valign="middle" bgcolor="#FFFFFF" class="line_bottom">是否锁定</th>
          <th height="31" align="center" valign="middle" bgcolor="#FFFFFF" class="line_bottom">注册时间</th>
        ...
        <tr class="line_bottom" bgcolor='${colors}'>
          ...
          <td height="27" align="center" valign="middle"  class="line_bottom" scope="row">${item.clientId}</td>
          ...
          <td height="27" align="center" valign="middle"  class="line_bottom" scope="row">${fn:substring(item.birth,0,10)}</td>
          <td height="27" align="center" valign="middle"  class="line_bottom" scope="row">${item.cardno}</td>
          <td height="27" align="center" valign="middle"  class="line_bottom" scope="row">${item.tel}</td>
          <td height="27" align="center" valign="middle"  class="line_bottom" scope="row">${item.address}</td>
          ...
          <td height="27" align="center" valign="middle"  class="line_bottom" scope="row">${fn:substring(item.regdate,0,10)}</td>
          <td height="27" align="right" valign="middle" width="4%">
            <a href="addclient.jsp?id=${item.id}"><img src="../images/edit.gif" alt="查看修改记录" height="16" border="0" style="cursor:hand" widtd="16"/></a>
          </td>
		    ...
		    <table width="100%">
              <tr>
	            ...
	            <c:if test="${Pagescoll!=0&&Pagescoll!=1}">
	              <a href="client.do?Page=1">首页</a>
                  <a href="client.do?Page=${Pageno-1}">上一页</a>
	            </c:if>
	            <c:if test="${Pagescoll!=0&&Pagescoll!=3}">
	              <a href="client.do?Page=${Pageno+1}">下一页</a>
                  <a href="client.do?Page=${Totalpage}">尾页</a>
	            </c:if>
	            选择页数：
	            <select onchange='javascript:window.location="client.do?Page=" + this.value;'>
        ...
        <tr class="line_bottom">
          <td height="26" colspan="17" align="center" valign="middle" bgcolor="#FFFFFF"  class="line_bottom" scope="row">
		    <img src="../images/fanxuan.gif" width="79" height="27"  class="shouxing" onclick="check()"/>&nbsp;<img src="../images/quanxuan.gif" width="79" height="27" class="shouxing" onclick="checkall()"/>&nbsp;&nbsp;
