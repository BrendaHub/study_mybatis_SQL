...
<table width="98%" border="0">
  <form name="form2" action="room.do" method="post" onsubmit="return checkname(this)">
  <tr>
    <td width="4"></td>
    <td height="25" align="left"  style="border-bottom: dashed 1px">
      输入房间号：<input type="text" name="roomId" value="" size="20" maxlength="50" />
      <input type="submit" value="查询" class="btn_1" />  
    </td>
  </tr>
  </form>
</table>
<form action="delroom.do" method="post" name="form1" target="main" id="form1" onsubmit="return CheckForm()">
<table width="98%" border="0">
  <tr>
    <td width="4">&nbsp;</td>
    <td height="25" align="left"  style="border-bottom: dashed 1px"><img src="../images/dot_process.gif" width="7" height="7" />&nbsp;管理员管理 &gt;&gt;&nbsp;房间信息列表</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
      ...
      <table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#B1C3D9" id=table1 style="margin-top:5px;">
        ...
        <tr class="line_bottom" bgcolor='${colors}'>
          ...
          <td height="27" align="right" valign="middle" width="4%">
            <a href="addroom.jsp?id=${item.id}"><img src="../images/edit.gif" alt="查看修改记录" height="16" border="0" style="cursor:hand" widtd="16"/></a>
          </td>
		    ...
		    <table width="100%">
              <tr>
	            ...
	            <c:if test="${Pagescoll!=0&&Pagescoll!=1}">
	              <a href="room.do?Page=1">首页</a>
                  <a href="room.do?Page=${Pageno-1}">上一页</a>
	            </c:if>
	            <c:if test="${Pagescoll!=0&&Pagescoll!=3}">
	              <a href="room.do?Page=${Pageno+1}">下一页</a>
                  <a href="room.do?Page=${Totalpage}">尾页</a>
	            </c:if>
	            选择页数：
	            <select onchange='javascript:window.location="room.do?Page=" + this.value;'>
        ...
        <tr class="line_bottom">
          <td height="26" colspan="17" align="center" valign="middle" bgcolor="#FFFFFF"  class="line_bottom" scope="row">
		    <a href="addroom.jsp"><img src="../images/tjjl.gif" width="78" height="27" border="0" /></a>&nbsp;<img src="../images/fanxuan.gif" width="79" height="27"  class="shouxing" onclick="check()"/>&nbsp;<img src="../images/quanxuan.gif" width="79" height="27" class="shouxing" onclick="checkall()"/>&nbsp;&nbsp;
