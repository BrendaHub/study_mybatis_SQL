...
var ct1=new ct()
function ct(){
        this.ac="#009900,#FFFF00,#FF0000,#0000FF,#999999,#FF6600,#CC0000,#0099FF,#669900,#FF00FF".split(",")
        ...
        this.bar=function(vList,css){
                ...
                for(i=0;i<10;i++){
                        l+="<v:line from="+30+","+(70+i*(ph-100)/10)+" to="+(pw-10)+","+(70+i*(ph-100)/10)+" strokecolor=#c0c0c0><v:stroke dashstyle=dash /></v:line>"
                        l+="<span style='position:absolute;z-index:3;font:12;left:"+10+";top:"+(65+i*(ph-100)/10)+"'>"+(parseInt(max)*(10-i)/10)+"</span>"
                }
                        ...
                        for(j in a[i]){
                                if(i==0){
                                        if(j>0){
                                                ...
                                                l+="<span style='position:absolute;z-index:3;font:12;left:"+(j*80+10)+";top:35'>"+a[i][j]+"</span>"
                                        }
                                }
                                else{
                                        if(j==0)
